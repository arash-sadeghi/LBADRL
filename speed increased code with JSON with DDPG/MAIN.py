...
def LOG():
    global sup, samplingPeriodSmall, it, sampled, save_csv, codeBeginTime,\
        ...
        showFrames, SAR, localMinima, t,started_second
    ...
    if sup.getTime() % samplingPeriodSmall == 0 and sup.getTime()-t > 1:
        ...
        if sampled%100==0:
            print(colored('\t[+] sim time >{:.2f}< real time passed >{:.2f}< percentage completed >{:.2f}%<'\
                .format(sup.getTime(),TIME()-started_second,sup.getTime()/FinalTime*100),'yellow'),end='\r')
        t = sup.getTime()
# ...............................................................................................................................
...
if __name__ == "__main__" or True:
    ...
    for it in range(iteration):
        ...
        if it == iteration-1:
            saveData("iterationDone")
        del sup
        print(colored("\t[+] iteration duration: ", 'blue'),
              int(TIME()-iteration_duration))
